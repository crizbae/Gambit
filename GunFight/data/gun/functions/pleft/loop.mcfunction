...
execute unless score #mode mode_id matches -1 unless score #mode mode_respawns matches 1 run scoreboard objectives setdisplay sidebar pleft_sidebar
execute unless score #mode mode_id matches -1 unless score #mode mode_respawns matches 1 run scoreboard players operation Red pleft_sidebar = #Red rcount
execute unless score #mode mode_id matches -1 unless score #mode mode_respawns matches 1 run scoreboard players operation Blue pleft_sidebar = #Blue bcount
execute unless score #mode mode_id matches -1 if score #mode mode_respawns matches 1 run scoreboard players operation Red tdm_kills = #Red tdm_red_kills
execute unless score #mode mode_id matches -1 if score #mode mode_respawns matches 1 run scoreboard players operation Blue tdm_kills = #Blue tdm_blue_kills
